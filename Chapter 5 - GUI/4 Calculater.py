...
# the expression present in the input field. For example: User clicks button 2, + and 3 then clicks "="
# will result in an output 5.
def btn_equal():
    global expression
...
input_field.pack(ipady=10)  # 'ipady' is an internal padding to increase the height of the input field
...
# Finally, the fifth row will comprise of the buttons '0', 'Decimal (.)', and 'Equals (=)'
